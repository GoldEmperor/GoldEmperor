...
public class ProcessSendActvity extends Activity implements ScrollListenerHorizontalScrollView.OnScrollListener {
    ...
    private TwinklingRefreshLayout TRL_ProcessSend;
...
//                getdata();
        ...
        TRL_ProcessSend.setHeaderView(headerView);
        TRL_ProcessSend.setEnableLoadmore(false);
        TRL_ProcessSend.setOverScrollRefreshShow(true);
        TRL_ProcessSend.setOnRefreshListener(new RefreshListenerAdapter() {
            @Override
...
//        LOG.e("PSML.size():" + PSML.size());
    ...
    private void getdata() {
        ...
        RequestParams RP = new RequestParams("http://192.168.99.79:8056/ErpForMesServer.asmx/GetSfcOperPlanningInfo");
...
//                            }
                            ...
                            TRL_ProcessSend.finishRefreshing();
