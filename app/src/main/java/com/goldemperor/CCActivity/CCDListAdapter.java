 ...
 */
public class CCDListAdapter extends SwipeMenuAdapter<CCDListAdapter.DefaultViewHolder> {
    ...
    @Override
    public CCDListAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
