...
import com.goldemperor.PgdActivity.Sc_ProcessWorkCardEntry;
...
public class GylxActivity extends AppCompatActivity {
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener = new OnSwipeMenuItemClickListener() {
         ...
         */
        @Override
        public void onItemClick(Closeable closeable, final int adapterPosition, final int menuPosition, int direction) {
