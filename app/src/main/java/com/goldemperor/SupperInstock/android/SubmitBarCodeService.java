package com.goldemperor.SupperInstock.android;
...
import com.goldemperor.SupperInstock.LoginActivity;
import com.goldemperor.SupperInstock.MainActivity;
...
public class SubmitBarCodeService extends Thread {
    ...
    private LoginActivity myloginActivity_instance;
    private String myallDataJson;

    public SubmitBarCodeService(Handler handler, Context context, LoginActivity loginActivity_instance, String allDataJson) {
        myHandler = handler;
        myContext = context;
