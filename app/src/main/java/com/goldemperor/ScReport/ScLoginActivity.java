...
public class ScLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScReportActivity.loginActivity_instance=ScLoginActivity.this;//以便在别的activity中可以直接调用
    }
        ...
        */
        public void DoLogin(Message msg)
        {
            ...
            if(result.equals("success") ) {
                ...
                UserInfoDBHelper.InsertUserInfo(userLoginInfo.userInfo);
                ScReportActivity.mainActivity_instance.ClearSubmitData(myContext,"CxLoginActivty");
            }
            else
            {
