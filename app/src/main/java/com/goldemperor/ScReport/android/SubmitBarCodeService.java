...
public class SubmitBarCodeService extends Thread {
    ...
    private ScLoginActivity myloginActivity_instance;
    private String myallDataJson;

    public SubmitBarCodeService(Handler handler, Context context, ScLoginActivity loginActivity_instance, String allDataJson) {
        myHandler = handler;
        myContext = context;
